...
<c:forEach items="${newUserList}" var="newUser">
	<div id="fixed_bar">
		<div class="topnav">
			<a href="Home.jsp">Home</a> <a class="active" href="#SearchCar">Search
				for a Car</a> <a href="ViewAllCars.jsp">View All Cars</a> <a
				href="SellCar.jsp">Sell My Car</a>
	...
	<div class="container-pic">
		...
		<img border="0" src="images/searchingcar.JPG" alt="Photo of the car"
			width=2050px height=270px />
	</div>
	<h6>
		Hello
		<c:forEach items="${newUserList}" var="newUser">
	...
	<h4>Search your favorite Cars here!</h4>
	<br>
